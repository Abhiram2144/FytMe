...
COLOR_HARMONY = {
    "black": ["white", "grey", "beige", "cream", "burgundy", "navy"],
    "white": ["black", "navy", "grey", "blue", "khaki", "beige", "brown"],
    "grey": ["black", "white", "navy", "blue", "burgundy", "pink"],
    "navy": ["white", "beige", "cream", "grey", "khaki", "burgundy"],
    "blue": ["white", "beige", "cream", "grey", "khaki", "brown"],
    "brown": ["cream", "beige", "white", "olive", "khaki", "burgundy"],
    "beige": ["navy", "brown", "white", "olive", "burgundy", "grey"],
    "khaki": ["navy", "white", "brown", "olive", "burgundy"],
    "cream": ["navy", "brown", "burgundy", "olive", "grey"],
    "olive": ["cream", "beige", "brown", "khaki", "burgundy"],
    "burgundy": ["navy", "grey", "cream", "beige", "black"],
    "red": ["black", "white", "navy", "grey"],
    "pink": ["grey", "navy", "white", "beige"],
    "green": ["beige", "brown", "cream", "white"],
    "purple": ["grey", "black", "white"],
    "orange": ["navy", "brown", "cream"],
    "yellow": ["navy", "grey", "white"],
    "teal": ["white", "beige", "grey"]
}
